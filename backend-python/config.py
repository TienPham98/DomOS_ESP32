...
class Settings(BaseSettings):
    ...
    # Kept empty instead of embedding a provider URL in source. Production
    # injects this value through its secret/config group.
    ...
    DEVICE_COMMAND_RETRY_WINDOW_SEC: int = 15
